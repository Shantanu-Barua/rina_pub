### Curve fitting for single plot in a single raw file with standard temperature in tags folder
...
output_folder = 'final/single_std'
tags_folder = 'tags'
...
output_file = os.path.join(output_folder, 'single_results_std_temp.xlsx')
