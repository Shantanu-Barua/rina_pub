### Curve fitting for multiple plot in a single raw file
...
output_file = os.path.join(output_folder, 'multi_results.xlsx')

### CSV file for R
"""-----------------------------------------------------------------------"""
csv_output_file = os.path.join(output_folder, 'multi_results.csv')
