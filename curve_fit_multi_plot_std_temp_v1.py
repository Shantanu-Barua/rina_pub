### Curve fitting for multiple plot in a single raw file with standard temperature in tags folder
...
### Folders
input_folder = 'source/multiple'
output_folder = 'final/multiple_std'
tags_folder = 'tags'
...
output_file = os.path.join(output_folder, 'multi_results_std_temp.xlsx')
            ...
            try:
                ...
                if len(filename_parts) > 1:
                    ...
                    if match:
                        ...
                        for group_df, sheet_id in zip(sorted_chunks, id_range):    ### Jyothi requested not to sort
